...
def make_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Create figures for the Burgers no-reg optimal-control example.")
    parser.add_argument("--control-dir", default="pinns_optimal_control_ill-posed/outputs/burgers_optimal_control/no_reg/sweep_wj/optimal_control_results")
    parser.add_argument("--sweep-dir", default="pinns_optimal_control_ill-posed/outputs/burgers_optimal_control/no_reg/sweep_wj/sweep_wj_results")
    parser.add_argument("--outdir", default="pinns_optimal_control_ill-posed/outputs/burgers_optimal_control/no_reg/figures")
    return parser
...
def main() -> None:
    ...
    plot_overview(control_dir, outdir / "fig_burgers_no_reg_optimal_overview.png")
    plot_wj_sweep(sweep_dir, outdir / "fig_burgers_no_reg_wj_sweep.png")
