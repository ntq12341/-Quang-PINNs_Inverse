...
def summarize_suite_errors(all_results):
    """Convert output of run_example_56_suite() into flat rows."""
    rows = []
...
def export_error_tables(all_results, output_dir="results56/tables"):
    ...
    summary_headers = [
        "noise", "alpha", "L2_global", "L2_line",
        "L1", "Linf", "L2", "RMSE", "SDE", "CV_percent",
    ]
